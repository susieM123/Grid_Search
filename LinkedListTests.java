 ...
 * 
 * Notes on how to compile and run are at end of the file. 
 */
...
// The LinkedListTests class is used to test my LinkedList class and methods.
public class LinkedListTests {
    ...
    public static void main(String[] args) {
        ...
        // case 9: testing remove()
        {
            ...
            // verify
            System.out.println(remove0 + " == 4");
            System.out.println(remove1 + " == 3");
        ...
        // case 10: testing remove(int index)
        {
            ...
            // verify
            System.out.println(remove0 + " == 7");
            System.out.println(remove3 + " == 3");
            System.out.println(remove5 + " == 0");
...

        {
            ...
            // test
            assert ll.size() == 5 : "Error in LinkedList::offer(T item)";
        }

        {
            ...
            // test
            assert value == 5 : "Error in LinkedList::peek()";
        }

        {
            ...
            System.out.println(poll1 + " == 5");
            System.out.println(poll2 + " == 4");

            // test
            assert poll1 == 5 : "Error in LinkedList::poll()";
            assert poll2 == 4 : "Error in LinkedList::poll()";
        }
...
/*
 * How to Compile: javac LinkedListTests.java
 * 
 * How to Run: java LinkedListTests
 */